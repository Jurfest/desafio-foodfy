module.exports = [{
    ...
    preparation: [
      ...
      'Fa??a por????es de 90 g a 100 g.',
      'Forre um pl??stico molhado em uma bancada e modele os hamb??rgueres utilizando um aro como base.',
      'Fa??a um de cada vez e retire o aro logo em seguida.',
      'Forre uma assadeira de metal com pl??stico, coloque os hamb??rgueres e intercale camadas de carne e pl??sticos (sem apertar).',
      'Fa??a no m??ximo 4 camadas por forma e leve para congelar.',
      'Retire do congelador, frite ou asse e est?? pronto.'
    ],
    information: "Preaque??a a chapa, frigideira ou grelha por 10 minutos antes de levar os hamb??rgueres. Adicione um pouquinho de ??leo ou manteiga e n??o amasse os hamb??rgueres! \n\n Voc?? sabia que a receita que precede o hamb??rguer surgiu no s??culo XIII, na Europa? A ideia de moer a carne chegou em Hamburgo no s??culo XVII, onde um a??ogueiro resolveu tamb??m temper??-la. Assim, a receita foi disseminada nos Estados Unidos por alem??es da regi??o. L?? surgiu a ideia de colocar o hamb??rguer no meio do p??o e adicionar outros ingredientes, como queijom tomates e alface."
  },
  {
    image: 'https://rocketseat-cdn.s3-sa-east-1.amazonaws.com/launchbase/receitas/pizza.png',
    title: 'Pizza 4 esta????es',
    author: 'Fabiana Melo',
    ingredients: [
    ...
    preparation: [
      'No liquidificador bata o leite, o ovo, o sal, o a????car, a margarina, a farinha de trigo e o fermento em p?? at?? que tudo esteja encorporado.',
    ...
    information: 'Pizza de liquidificador ?? uma receita deliciosa e supersimples de preparar. Feita toda no liquidificador, ela ?? bem pr??tica para o dia a dia. Aqui no TudoGostoso voc?? tamb??m encontra diversas del??cias pr??ticas feitas no liquidificador: massa de panqueca, torta de frango de liquidificador, p??o de queijo de liquidificador, bolo de banana, bolo de chocolate e muito mais!'
  },
  {
  ...
  },
  {
    ...
    preparation: [
      ...
      'Coloque as por????es nos pratos j?? com o cheiro do alho, e enfeite com algumas ervas.'
    ],
  ...
  },
  {
    ...
    ingredients: [
      ...
      '3 colheres (sopa) de a????car 1 lata de Leite Mo??a',
    ...
    preparation: [
      ...
      'Junte a manteiga,os ovos, o coco ralado,o a????car, o Leite Mo??a e o fermento em p??, mexendo bem ap??s cada adi????o.',
      'Despeje em assadeira retangular m??dia, untada e leve ao forno m??dio (180??C), por aproximadamente 45 minutos. Depois de frio, polvilhe, com o',
      'a????car de confeiteiro e corte em quadrados.'
    ],
    information: ''
  }
];